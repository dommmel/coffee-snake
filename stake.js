...
(function() {
  ...
  Game = (function(_super) {
    ...
    Game.prototype.endGame = function() {
      ...
      _ref1 = ["Score: " + this.score, this.tx / 2, this.ty / 1.7], mess = _ref1[0], x = _ref1[1], y = _ref1[2];
      atom.context.fillText(mess, x, y);
      atom.context.strokeText(mess, x, y);
      return _gaq.push(['_trackEvent', 'Game', 'End', void 0, this.score]);
    };
